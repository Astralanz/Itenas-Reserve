...
<div class="sidebar">
    <div>
        <div class="profile-section">
            <!-- INI YANG BIKIN FOTO MUNCUL DAN GAK NGERUSAK CSS (Pake Inline CSS) -->
...
<div class="modal-profil-overlay" id="modalProfilUser" onclick="tutupModalProfil(event)">
    <div class="modal-profil-box">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="btn-simpan-wrapper"><button type="submit" name="simpan_profil" class="btn-simpan">Simpan</button></div>
        </form>
    </div>
</div>
...
<script>
    ...
    function previewImage(event) {
        ...
        reader.onload = function(){ document.getElementById('preview_avatar').src = reader.result; };
...
>>>>>>> 27c32c1dde65f7282e88fff770ce33d30ca70464
</script>